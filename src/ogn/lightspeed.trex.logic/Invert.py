...
class Invert:
    @staticmethod
    def compute(_db: InvertDatabase):
        return True
    ...
    def on_connection_type_resolve(node) -> None:
        ...
        # Combination 1: input=float, output=float
        # Combination 2: input=float[2], output=float[2]
        # Combination 3: input=float[3], output=float[3]
        # Combination 4: input=float[4], output=float[4]
